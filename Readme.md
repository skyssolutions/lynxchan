...
# Required software
* [Node.js](http://nodejs.org) 6.5.0, I suggest installing from source code. DO NOT build the master's HEAD.
...
* [ffmpeg](https://www.ffmpeg.org/) (Optional) 3.1.1 if mediaThumb setting is enabled. Requires zlib-devel on centOS to work properly when compiled from source.
